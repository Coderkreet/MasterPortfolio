...
const Contect = () => {
  ...
  <a target='_blank' class="social-link4">
   <img src={Whatsaap} width={"50rem"} alt=""/>
  </a>
      </div> 
      {/* resume btn */}
      <button className="m-10 cta">
    ...
    <polyline points="8 1 12 5 8 9"></polyline>
     ...
     <img src={Contectimg} alt="" width={500} />
      <div className='flex flex-col gap-10 text-center'>
        ...
        <p className='font-bold text-[1.1rem] text-[#7f8daa]'>Ambavadi vas, Kanodar, T.A.-Palanpur, Dist.-Banaskantha, Gujarat - 385520</p>
        <div className='flex justify-center items-center gap-x-4'>
        <BsFillTelephoneInboundFill className='text-[#001c55]'/> 
    <p className='text-[#001c55] text-[1.2rem] '> <span className=' font-bold'>  Phone No. :</span> 9300631627</p>
        </div>
      </div>
