...
const NavBar = () => {
  ...
  <nav className='lg:flex lg:max-w-[1080px]  w-full lg:w-full p-3  lg:p-5  justify-between bg-[#edf9fe] lg:justify-between'>
          ...
          <Link to={'/'}>
     <li id='Fname' className=' lg:text-[2rem] lg:text-3xl lg:font-extralight font-bold text-[1.3rem] text-[#001c55]' > &lt; KrunalBende   /&gt;</li>
     </Link>   
     <button className='lg:hidden' onClick={heandlemanu}>{open} {buttonText} </button>
        ...
        <Link to={"/"} >  <li className=' p-3 hover:bg-[rgb(166,225,250)] translate-100 hover:font-bold' >Home </li> </Link>
        <Link to={"/Education"} id='Education' >  <li className=' p-3 hover:bg-[rgb(166,225,250)] translate-100 hover:font-bold' >Education </li> </Link>
    <Link to={"/Skills"} id='Skills'> <li className='p-3 hover:bg-[rgb(166,225,250)] translate-100 hover:font-bold' >Skills</li> </Link>
    <Link to={'/Project'}> <li className=' p-3 hover:bg-[rgb(166,225,250)] translate-100 hover:font-bold' >Project</li> </Link>
    <Link to={"/Contect"}>  <li className='p-3 hover:bg-[rgb(166,225,250)] translate-100 hover:font-bold' >Contect Me</li> </Link>
    </ul>
